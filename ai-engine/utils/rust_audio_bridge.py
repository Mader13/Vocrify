    ...
    def convert_to_wav(
        ...
        if self.use_rust:
            try:
                ...
                print(f"[RustAudioBridge] Rust convert failed: {e}, falling back to Python", file=sys.stderr)
    ...
    def get_duration(self, file_path: str) -> float:
        ...
        if self.use_rust:
            try:
                ...
                print(f"[RustAudioBridge] Rust duration failed: {e}, falling back to Python", file=sys.stderr)
    ...
    def slice_audio(
        ...
        if self.use_rust:
            try:
                ...
                print(f"[RustAudioBridge] Rust slice failed: {e}, falling back to Python", file=sys.stderr)
